...
(function iife (inject) {
  ...
  let ENABLE_UNLOCK_CONFIRMATION_EMBED = false;
  ...
  function unlockResponse$1 (playerResponse) {
    ...
    if (
      ...
      throw new Error(
        `Player Unlock Failed, playabilityStatus: ${(_unlockedPlayerRespon2 = unlockedPlayerResponse.playabilityStatus) === null || _unlockedPlayerRespon2 === void 0 ? void 0 : _unlockedPlayerRespon2.status
        }`
      );
    }
